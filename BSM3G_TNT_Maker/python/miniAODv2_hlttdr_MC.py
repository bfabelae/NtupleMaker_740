...
# process.load('Configuration.Geometry.GeometryRecoDB_cff') # original
...
process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring(
    ...
    '/store/mc/Phase2HLTTDRWinter20RECOMiniAOD/DYToLL_M-50_TuneCP5_14TeV-pythia8/MINIAODSIM/NoPU_pilot_110X_mcRun4_realistic_v3-v2/20000/2162EDF6-A4F2-714E-9A8F-1DB2807524A2.root',
  )
)
